						...
						<div class="col-md-9">
							...
							<div class="dv_account_payment_data_card">
								<div class="row">
									...
									<div class="col-md-6">
										...
										<div class="dv_transation_count_cc">
											<strong>12</strong> Transaction done <span>remove</span>
										</div>
									</div>
									<div class="col-md-6">
										<div class="dv_credit_debit_card_wrapper">
										...
										<div class="dv_transation_count_cc">
											<strong>0</strong> Transaction done <span>remove</span>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="dv_show_question_card">
								<div class="dv_question_txt_help">
									payments question will come here
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
								</div>
								<div class="dv_answer_txt_help">
									payments question answer will come here
								</div>
							</div>
							<div class="dv_show_question_card">
								<div class="dv_question_txt_help">
