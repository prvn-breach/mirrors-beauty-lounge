    ...
    <div id="content" class="flex">
        <div class="page-container">
            <div class="pt-3 pr-3 pb-5 pl-3">
                <div class="mb-5">
                    <h2 class="dv_page_heading">InComplete Order - <span>{{ orderDetail.id }}</span>
                                ...
                                <div class="b-b">
                                    <div class="nav-active-border b-primary bottom">
                                        <ul class="nav" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item"><a class="nav-link dv_tabs_a_tag" id="contact-tab" data-toggle="tab" href="#Followup" role="tab" aria-controls="contact" aria-selected="false"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 18v-6a9 9 0 0 1 18 0v6"></path><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"></path></svg>Followup</a></li>
                                        </ul>
                                    </div>
                                </div>
    ...
    methods: {
        ...
        getOrderDetail: function() {
            this.$store.dispatch('getOrder/' + GET_ORDER_ACTION, this.$route.params.order_id).then(() => {
                ...
                this.returned.reason = this.orderDetail.order_payment.reason;
                ...
                if (this.orderDetail.order_address) {
                    this.billing_info.mobile = this.orderDetail.order_address.mobile;
                    this.billing_info.phone = this.orderDetail.order_address.telephone;
                    this.billing_info.address1 = this.orderDetail.order_address.address;
                    this.billing_info.city = this.orderDetail.order_address.city;
                    this.billing_info.state = this.orderDetail.order_address.state;
                    this.billing_info.postal_code = this.orderDetail.order_address.postal_code;
                    this.billing_info.country = this.orderDetail.order_address.country;
                }
        ...
        updateOrder: function(){
            ...
            this.$store.dispatch('getOrder/' + UPDATE_ORDER_STATUS_ACTION, {
                ...
                this.$router.push({ name: 'getInCompleteOrders' });
            })
        }
    }
}
