  ...
  <div id="content" class="flex">
    <div class="page-container">
      <div class="pt-3 pr-3 pb-5 pl-3">
        <div class="mb-5">
          <h2 class="dv_page_heading">Cancelled Orders List</h2>
            ...
            <table class="table table-theme table-row v-middle">
              <thead>
                <tr>
                  ...
                  <th style="width: 10%" class="text-muted">date</th>
              ...
              <tbody>
                <tr v-for="(order, index) in getOrders.data" :key="index" class="v-middle">
                  ...
                  <td>
                      <router-link :to="{ name : 'cancelledOrderDetail', params: { order_id: order.id } }">
...
export default {
    ...
    data() {
        return {
            ...
            excel_fields: [ 'Order ID', 'Customer Name', 'Customer Email', 'Customer Mobile', 'Shipping Status', 'Products', 'Shipping Date' ],
            excel_db_columns: [
                { column : 'id' },
    ...
    methods: {
        ...
        excelDownload: function() {
            ...
            this.$store.dispatch('getOrder/' + EXCEL_DOWNLOAD_ORDERS_ACTION, params).then(() => {
                ...
                link.setAttribute("download", "cancelled_orders.xlsx"); //or any other extension
