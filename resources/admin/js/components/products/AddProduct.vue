	  ...
	  <div id="content" class="flex">
                <div class="page-container">
                    <div class="pt-3 pr-3 pb-5 pl-3">
                        <div class="mb-5">
                            <h2 class="dv_page_heading">Add Product </h2>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.name" :class="status($v.addProduct.name)" @input="setProductName($event.target.value)" @focusout="getSlug">
                                            </div> 
                                            <div class="form-group">
                                                <label class="text-muted text-capitalize" for="name">Slug </label>
                                                <input type="text" @keydown="removeSpecialSymbols" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.slug" :class="status($v.addProduct.slug)" @input="setProductSlug($event.target.value)">
                                                <span class="text-danger" v-if="getError.hasOwnProperty('slug')">{{ getError['slug'][0] }}</span>
                                            </div>
                                            <!-- <div class="form-group">
                                                <label class="text-muted text-capitalize" for="name">Product group / Model number </label>
                                                <input type="email" class="form-control dv_common_input_for_all" placeholder="Enter"  v-model="addProduct.model_number" :class="status($v.addProduct.model_number)" @input="setProductModelNumber($event.target.value)">
                                            </div> -->
                                            <div class="form-group mb-0">
                                                <label class="ui-switch ui-switch-md info m-t-xs float-left mr-3"><input @change="changeProductStatus" :checked="addProduct.status=='A'" type="checkbox"> <i></i></label>
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="text-muted text-capitalize" for="name">Product Quantity</label>
                                                        <input type="number" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.product_quantity" :class="status($v.addProduct.product_quantity)" @input="setProductQty($event.target.value)">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="text-muted text-capitalize" for="name">Product Code</label>
                                                        <input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.product_code" :class="status($v.addProduct.product_code)" @input="setProductCode($event.target.value)">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="text-muted text-capitalize" for="name">Availibility </label>
                                                        <select class="form-control dv_common_select_for_all" v-model="addProduct.availibility" :class="status($v.addProduct.availibility)" @change="setProductAvailibility($event.target.value)">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.sku" :class="status($v.addProduct.sku)" @input="setProductSku($event.target.value)">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="text-muted text-capitalize" for="name">UPC / Barcode</label>
                                                        <input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.barcode" :class="status($v.addProduct.barcode)" @input="setProductBarcode($event.target.value)">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control dv_common_select_for_all" v-model="addProduct.brand" :class="status($v.addProduct.brand)" @input="setProductBrand($event.target.value)" @change="onBrandChange">
                                                            <option value="">Select Brand</option>
                                                            <option :value="getBrand.id" v-for="(getBrand,index) in getBrands" :key="index">{{getBrand.name}} </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.upc">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="text-muted text-capitalize" for="name">Active </label>
                                                        <select class="form-control dv_common_select_for_all" v-model="addProduct.active">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="text-muted text-capitalize" for="name">Color</label>
                                                        <input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.color">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="text-muted text-capitalize" for="name">Size</label>
                                                        <input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.size">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="text-muted text-capitalize" for="name">Size Measurment </label>
                                                        <select class="form-control dv_common_select_for_all" v-model="addProduct.size_measurment">
                                                            <option value="">Select </option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.sale_price" :class="status($v.addProduct.sale_price)"  @input="setProductSalePrice($event.target.value)">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="text-muted text-capitalize" for="name">Discount Price </label>
                                                        <input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.discount_price" @focusout="getCulcDiscountPrice" :class="status($v.addProduct.discount_price)"  @input="setProductDiscountPrice($event.target.value)">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="text-muted text-capitalize" for="name">Discount % </label>
                                                        <input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.discount" @focusout="getCulcDiscount" :class="status($v.addProduct.discount)"  @input="setProductDiscountPercentage($event.target.value)">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="ui-switch ui-switch-md info m-t-xs"><input v-model="addProduct.is_exclusive_deal" type="checkbox" @change="changeIsExclusiveDeal"> <i></i></label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="text-muted text-capitalize w-100" for="name">Is Featured? </label>
                                                        <label class="ui-switch ui-switch-md info m-t-xs"><input v-model="addProduct.is_feature"  type="checkbox"  @change="changeIsFeature"> <i></i></label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="text-muted text-capitalize w-100" for="name">Is New? </label>
                                                        <label class="ui-switch ui-switch-md info m-t-xs"><input v-model="addProduct.is_new"  type="checkbox"  @change="changeIsNew"> <i></i></label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="text-muted text-capitalize w-100" for="name">Is Authorised Dealer </label>
                                                        <label class="ui-switch ui-switch-md info m-t-xs"><input v-model="addProduct.is_authorised_dealer"  type="checkbox"  @change="changeIsAuthorisedDealer"> <i></i></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <router-link :to="{ name : 'addCategory', params : { category_id: categoryId }, query: { tab: 'attributes' } }" tag="button" class="btn btn-default dv_filter_common" data-toggle="tooltip" data-placement="top" title="Add Attribute">                           
                                            ...
                                            <table class="table table-theme table-row v-middle">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr v-for="(spc,index) in addProduct.specification">
                                                        ...
                                                        <td><input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="spc.name.data" :class="spc.name.class"></td>
                                                        <td><input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="spc.value.data" :class="spc.value.class"></td>
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <vue-editor v-model="addProduct.other_description"></vue-editor>
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.warranty">
                                            </div>
                                            <div class="form-group">
                                                <label class="text-muted text-capitalize" for="name">Delivery </label>
                                                <input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.delivery">
                                            </div>
                                            <div class="form-group">
                                                <label class="text-muted text-capitalize" for="name">Select tags </label>
                                                <b-form-tags input-id="tags-basic"  v-model="addProduct.tags"></b-form-tags>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control dv_common_input_for_all" multiple="" @change="onFileChange" :class="status($v.addProduct.images)">
                                            </div>
                                            <ul class="dv_varient_product_images_ul">
                                                <li v-for="(preview,index) in getProductImagePreview" :key="index"><img :src="preview.image"  class="dv_added_img_varient"><svg @click ="deleteImage(preview,index)" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></li>
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.seo_title">
                                            </div>
                                            <div class="form-group">
                                                <label class="text-muted text-capitalize" for="name">SEO keywords </label>
                                                <input type="text" class="form-control dv_common_input_for_all" placeholder="Enter" v-model="addProduct.seo_keyword">
                                            </div>
                                            <div class="form-group m-0">
                                                <label class="text-muted text-capitalize" for="name">Description </label>
                                                <textarea class="form-control dv_common_textarea_for_all" rows="6" style="resize: none;" placeholder="Enter" v-model="addProduct.description"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 text-center">
                                    <button type="button" class="btn btn-default text-muted dv_cancel_submit_btn" @click="$router.push({ name: 'getProducts' });">cancel</button>
                                    <button type="button" class="btn btn-default dv_save_submit_btn" @click="submitProduct(1)" v-if="allowAction(1)">save edit </button> 
                                    <!-- <button type="button" class="btn btn-default dv_save_submit_btn" @click="submitProduct(2)" v-if="allowAction(2)">Copy</button>  -->
                                    <button type="button" class="btn btn-default dv_save_submit_btn" @click="submitProduct(0)" v-if="allowAction(0)">save add </button>
                                </div>
                            </div>
...
import { ADD_PRODUCT_ACTION,LOAD_SELECT_BRAND_LIST_ACTION,LOAD_GET_PRODUCT_ACTION,DELETE_SPECIFICATION_PRODUCT_ACTION,DELETE_PRODUCT_IMAGE_ACTION } from '@admin/store/products/actions'
...
export default {
    ...
    methods: {
        ...
        setCategory:function(value){
            this.addProduct.category_id = value
            this.$v.addProduct.category_id.$touch()
        },
        setProductDiscountPrice:function(value){
            this.addProduct.discount_price = value
            this.$v.addProduct.discount_price.$touch()
        },
        setProductDiscountPercentage:function(value){
            this.addProduct.discount = value
            this.$v.addProduct.discount.$touch()
        },
        setProductSalePrice:function(value){
            this.addProduct.sale_price = value
            this.$v.addProduct.sale_price.$touch()
        ...
        setProductSlug:function(value){
            this.addProduct.slug = value
            this.$v.addProduct.slug.$touch()
        },
        ...
        setProductQty:function(value){
                this.addProduct.product_quantity = value
            this.$v.addProduct.product_quantity.$touch()
        },
        ...
        setProductBrand:function(value){
            this.addProduct.brand = value
            this.$v.addProduct.brand.$touch()
        },
        ...
        submitProduct:function(action){
            ...
            _this.addProduct.specification = _this.addProduct.specification.filter(specification => {
                if (specification.name['data']!= '' && specification.value['data']!= '') {
            ...
            if (!_this.$v.addProduct.$invalid) {
                ...
                _this.addProduct['created_by'] = this.$admin.id;
        ...
        changeIsExclusiveDeal:function(event){
            ...
            if(event.target.checked == true){
                ...
                _this.addProduct.is_exclusive_deal = 0;
            }
        },
        ...
        onBrandChange: function(event) {
            if (event.target.value) {
                let brand = this.getBrands.find(brand => brand.id == event.target.value);
                // this.addProduct.category_id = brand.category_id;
                // this.addProduct.sub_category_id = brand.sub_category_id;
                this.getChangeAttribute(brand.category_id)
            } else {
                // this.addProduct.category_id = "";
                // this.addProduct.sub_category_id = "";
                this.addProduct.attributes = [];
            }
        },
        getChangeAttribute:function(category_id){
            this.addProduct.attributes = [];
            let id = category_id;
            let _this = this;
        ...
        removeSpecialSymbols: function(e) {
            if (/^\W$/.test(e.key)) {
                e.preventDefault();
            }
        },
        getSlug:function(event){
            ...
            this.addProduct.slug = name.replace(/\s+/g, '-').toLowerCase();
        },
        resetSubCategories(){
            this.addProduct.sub_category_id = "";
        },
        getSubCategories(){
            if (this.addProduct.category_id) {
                let query = [];
                query['params'] = {
