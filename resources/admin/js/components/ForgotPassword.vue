                        ...
                        <div class="p-3 p-md-4">
                            ...
                            <form class="" role="form">
                                <div class="form-group">
                                    ...
                                    <input v-model="forgotPassword.email" :class="status($v.forgotPassword.email)" type="text" class="form-control dv_common_input_for_all" placeholder="Enter email" />
                                ...
                                <button type="button" class="btn btn-primary mb-4 dv_login_btn" @click="submit">Submit</button>
                                <div class="my-3 text-center">Back to <router-link :to="{ name: 'login' }" class="ml-1"><strong>Sign In</strong></router-link></div>
                            </form>
                        </div>
                    </div>
                </div>
...
import { FORGOT_PASSWORD_ACTION  } from '@admin/store/users/actions'
