    ...
    <div id="content" class="flex">
        <div class="page-container">
            <div class="pt-3 pr-3 pb-5 pl-3">
                <div class="mb-5">
                    <h2 class="dv_page_heading">CMS Pages </h2>
                    <div class="row dv_search_delete_action_common">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-7 col-7">
                            <router-link :to="{ name: 'addCMSPage' }" tag="button" class="btn btn-default dv_filter_common" data-toggle="tooltip" data-placement="top" title="Add CMS Page">
                        ...
                        <table class="table table-theme table-row v-middle">
                            ...
                            <tbody>
                                <tr v-for="(page,index) in getCMSPages.data" :key="index" class="v-middle">
                                    ...
                                    <td>
                                        <router-link :to="{ name: 'viewCMS', params: { cms_page_id: page.id } }">
...
export default {
    ...
    methods: {
        ...
        updateCMSPage: function(event, cms_page_id) {
            ...
            this.$store.dispatch('getDesign/' + UPDATE_CMS_PAGE_ACTION, { cms_page_id, status: event.target.checked }).then(() => {
