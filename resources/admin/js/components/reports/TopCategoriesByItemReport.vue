    ...
    <div id="content" class="flex">
        <div class="page-container">
            <div class="pt-3 pr-3 pb-5 pl-3">
                <div class="mb-5">
                    <h2 class="dv_page_heading mb-0">Top 10 Categories(Item) </h2>
...
export default {
    ...
    data() {
        return {
            ...
            excel_fields: [ 'Category ID', 'Category Name', 'No. of Items' ],
            excel_db_columns: [ 
                { column: 'category_id' },
    ...
    methods: {
        ...
        excelDownload: function() {
            ...
            this.$store.dispatch('getReport/' + EXCEL_DOWNLOAD_CATEGORY_SALE_COST_REPORT_ACTION, params).then(() => {
                ...
                link.setAttribute("download", "TopCategoriesByItemsReport.xlsx"); //or any other extension
        ...
        chartConfig: function() {
            ...
            this.getCategories.data.forEach(value => {
                ...
                data.push(value['total_quantity']);
            });
