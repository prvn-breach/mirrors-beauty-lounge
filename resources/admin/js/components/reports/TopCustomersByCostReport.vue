    ...
    <div id="content" class="flex">
        <div class="page-container">
            <div class="pt-3 pr-3 pb-5 pl-3">
                <div class="mb-5">
                    <h2 class="dv_page_heading">Top 10 Customers(Cost) </h2>
                    <div class="row dv_search_delete_action_common">
                        <div class="col-md-5 col-sm-5 col-xs-5 col-5">
                            <!-- <input v-model="filters.search" @input="getCustomerSaleCostReport" type="text" class="form-control dv_common_search_for_all" name="" placeholder="Search"> -->
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <button type="button" class="btn btn-default dv_save_submit_btn" style="margin-top: 26px;" @click="getCustomerSaleCostReport">Filter</button>
                                        </div>
                                    </div>
                                </div>
                            </div>                                    
                        ...
                        <table class="table table-theme table-row v-middle">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 15%;" class="text-muted">total price</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="(customer,index) in getCustomers.data" :key="index" class="v-middle">
                                    ...
                                    <td>
                                        <strong>{{ customer['total_price'] }}</strong>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
export default {
    ...
    data() {
        return {
            ...
            excel_fields: [ 'Customer ID', 'Customer Name', 'Total Price' ],
            excel_db_columns: [
                { column: 'user_id' },
    ...
    mounted() {
        this.getCustomerSaleCostReport();
    },
    methods: {
        getCustomerSaleCostReport: function(page = 1) {
            let query = [];
        ...
        excelDownload: function() {
            ...
            this.$store.dispatch('getReport/' + EXCEL_DOWNLOAD_CUSTOMER_SALES_REPORT_ACTION, params).then(() => {
                ...
                link.setAttribute("download", "TopCustomersByCostReport.xlsx"); //or any other extension
