    ...
    <div id="content" class="flex">
        <div class="page-container">
            <div class="pt-3 pr-3 pb-5 pl-3">
                <div class="mb-5">
                    <h2 class="dv_page_heading mb-0">Top 10 Categories(Cost) </h2>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="graph" role="tabpanel" aria-labelledby="graph-tab">
                                    <div class="card mb-3">
                                        <div class="card-header"><strong>Categories Graph </strong></div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
...
export default {
    ...
    data() {
        return {
            ...
            excel_fields: [ 'Category ID', 'Category Name', 'Total Price' ],
            excel_db_columns: [ 
                { column: 'category_id' },
    ...
    methods: {
        getCategorySaleCostReport: function(page = 1) {
            ...
            this.$store.dispatch('getReport/' + GET_TOP_CATEGORY_SALES_REPORT_ACTION, query).then(() => {
                this.chartConfig();
            });
        },
        excelDownload: function() {
            ...
            this.$store.dispatch('getReport/' + EXCEL_DOWNLOAD_CATEGORY_SALE_COST_REPORT_ACTION, params).then(() => {
                ...
                link.setAttribute("download", "TopCategoriesByCostReport.xlsx"); //or any other extension
        ...
        chartConfig: function() {
            ...
            let data = [];
            let labels = [];
            this.getCategories.data.forEach(value => {
                labels.push(value['category']['name'] ?? '');
                data.push(value['total_price']);
            });
