    ...
    <div id="content" class="flex">
        <div class="page-container">
            <div class="pt-3 pr-3 pb-5 pl-3">
                <div class="mb-5">
                    <h2 class="dv_page_heading mb-0">Top 10 Products(Cost) </h2>
                                ...
                                <div class="tab-pane fade" id="table" role="tabpanel" aria-labelledby="table-tab">
                                    <div class="table-responsive">
                                        <table class="table table-theme table-row v-middle">
                                            <thead>
                                                <tr>
                                                    <th style="width: 10%;" class="text-muted sortable">product id</th>
                                                    <th style="width: 25%;" class="text-muted sortable">product</th>
                                                    <th style="width: 10%;" class="text-muted">total price</th>
                                                </tr>
                                            </thead>
                                            <tbody>
...
export default {
    ...
    data() {
        return {
            ...
            excel_fields: [ 'Product ID', 'Product Name', 'Total Price' ],
            excel_db_columns: [
                { column: 'id' },
                { column: 'name' },
                { column: 'total_price' }
    ...
    methods: {
        ...
        excelDownload: function() {
            ...
            this.$store.dispatch('getReport/' + EXCEL_DOWNLOAD_PRODUCT_SALE_COST_REPORT_ACTION, params).then(() => {
                ...
                link.setAttribute("download", "TopProductsByCostReport.xlsx"); //or any other extension
