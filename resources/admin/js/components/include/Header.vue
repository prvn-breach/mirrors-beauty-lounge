<template>
<div>
<header class="page-header bg-white box-shadow sticky">
            <div class="navbar navbar-expand-lg">
                <!-- brand -->
                <a href="#!" class="navbar-brand">
                    <span class="hidden-folded d-inline l-s-n-1x m-0">
                ...
                <!-- <button type="button" class="btn btn-default dv_add_new_shortcut">
                    <i data-feather="plus"></i>
                    add new
                </button> -->
                <button @click="redirectToUpdateProfile" type="button" class="btn btn-default dv_add_new_shortcut pt-2 dv_logout_btn edit_profile_btn">
                    <i data-feather="settings" class="mr-1"></i>
                    Edit Profile
                </button>
                <button type="button" class="btn btn-default dv_logout_btn" @click="signout">
        ...
        computed:{
         ...
         methods: {
            ...
            redirectToUpdateProfile: function() {
                ...
                names[names.length-1] = 'update-profile';
                let path = names.join("/");
...
@media only screen and (max-width: 600px) {
    button.btn.btn-default.edit_profile_btn {
