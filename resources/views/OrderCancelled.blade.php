...
<body yahoo="fix" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  <!--Main Table Start-->
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#e6e7e8" style="background:#e6e7e8;">
        <tr>
                    ...
                    <tr>
                        ...
                        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="main">
                            ...
                            <td height="80" align="center" valign="middle" bgcolor="#e6e7e8" style="background:#e6e7e8;">
                                ...
                                <tr>
                                    <td align="center" style="font-family: 'Gotham', sans-serif; font-size:13px; color:#333; font-weight:normal;line-height:22px;" mc:edit="view">
                    ...
                    <tr>
                        ...
                        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="main">
                            ...
                            <td height="333" align="center" valign="top" bgcolor="#0f0c0b"
                                style="background: url({{ $message->embed(public_path('images/email-template-images/head-bg.jpg')) }}) #0f0c0b no-repeat; height:350px;">
                            ...
                            <td align="center" valign="top" bgcolor="#ff9ba1" style="background:#ff9ba1;">
                                ...
                                <tr>
                                    ...
                                    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                        <tr>
                                        <td align="center" valign="top"
                                            style="font-family: 'Gotham', sans-serif; font-size: 18px; color: #000; font-weight: 500; text-transform: uppercase; padding: 0 0 15px 0;"
                                            mc:edit="single-post-image-title">
                                            <multiline>#{{ $order['id'] }} </multiline>
                                        </td>
                                        </tr>
                                        <tr>
                                        <td align="center" valign="top"
                                            ...
                                            mc:edit="single-post-image-title">
                                            <multiline>Order Cancelled </multiline>
                                        </td>
                                        </tr>
                                        <tr>
                                        <td align="center" valign="top"
                                            style="font-family: 'Gotham', sans-serif; font-size:13px; color:#FFF; font-weight:normal; padding-top:10px;"
                                            mc:edit="single-post-image-inner">
                                            <multiline>You will get the update on website in your orders </multiline>
                                        </td>
                                        </tr>
                                    </table>
                                    </td>
                            ...
                            <td align="center" valign="top">
                                ...
                                <tbody>
                                    ...
                                    <td align="center" valign="top" bgcolor="#FFFFFF" style="background:#FFFFFF;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td height="50" align="center" valign="top" style="border-top:#f1f1f1 solid 1px;">&nbsp;
                                                </td>
                                            </tr>
                                        </tbody>
                                        </table>
                                        ...
                                        <table width="560" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left">
                                            <tr>
                                                ...
                                                <table width="185" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        @if(count($item['getProduct']['getProductImages']) > 0)
                                                        <td align="left" valign="top">
                                                            <img border="1" mc:edit="1-row-1-image" editable="true"
                                                        src="{{ $message->embed(public_path('images/products/'.$item['getProduct']['getProductImages'][0]['image'] )) }}" width="185" height="185"
                                                        style="display:block; border-color: #ebebeb;" alt="" />
                                                        </td>
                                                        @endif
                                                    </tr>
                                                    <tr>
                                                ...
                                                <table width="330" border="0" align="right" cellpadding="0" cellspacing="0" class="two-left">
                                                    <tr>
                                                    <td align="left" valign="top">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td align="left" valign="top"
                                                            style="font-family: 'Gotham', sans-serif; font-size:13px; color:#767575; font-weight:normal;line-height:20px; padding:0px 0px 8px 0px;"
                                                            mc:edit="our-latest-2column-image21-inner">
                                                            <multiline>{{ !empty($item['getBrand']) ? $item['getBrand']['name'] : '' }} </multiline>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" valign="top"
                                                            style="font-family: 'Gotham', sans-serif; font-size:22px; color:#3f3d3d; font-weight:500; line-height:24px;"
                                                            mc:edit="1-row-1-title">
                                                            <multiline>{{ $item['product_name'] }} </multiline>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" valign="top"
                                                            style="font-family: 'Gotham', sans-serif; font-size:20px; color:#3f3d3d; font-weight:normal; padding: 8px 0px 8px 0px; line-height:24px;"
                                                            mc:edit="1-row-1-title">
                                                            <multiline>Qty : {{ $item['quantity'] }} </multiline>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" valign="top"
                                                            style="font-family: 'Gotham', sans-serif; font-size:20px; color:#ff9ba1; font-weight:600; padding: 20px 0px 20px 0px; line-height:24px;"
                                                            mc:edit="1-row-1-title">
                                                            <multiline>AED {{ $item['price'] }} </multiline>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td align="center" valign="top" bgcolor="#FFFFFF" style="background:#FFFFFF;">
                                                <table width="560" border="0" align="center" cellpadding="0" cellspacing="0" class="two-left">
                                                    <tbody>
                                                            ...
                                                            <td align="left" valign="top">
                                                                            ...
                                                                            <td align="left" valign="top">
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td align="left" valign="top"
                                                                                                style="font-family: 'Gotham', sans-serif; font-size:15px; color:#3f3d3d; font-weight:normal; line-height:24px;"
                                                                                                mc:edit="1-row-2-title">
                                                                                                <multiline>Payment type </multiline>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <td align="right" valign="top"
                                                                        style="font-family: 'Gotham', sans-serif; font-size:15px; color:#000000; font-weight:600; line-height:24px;"
                                                                        mc:edit="1-row-2-title">
                                                                        <multiline>{{ $order['getPayment']['payment_mode'] }} </multiline>
                                                                    </td>   
                                                                    </tr>
                                                                    <tr>
                                                        ...
                                                        <tr>
                                                            <td height="20" align="center" valign="top" style="border-top:#f1f1f1 solid 1px;">&nbsp;
                                                            </td>
                                                        </tr>
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <tbody>
                                                ...
                                                <td align="right" valign="top"
                                                    style="font-family: 'Gotham', sans-serif; font-size:15px; color:#000000; font-weight:600; line-height:24px;"
                                                    mc:edit="1-row-2-title">
                                                    <multiline>AED {{ $order['getPayment']['sub_total'] }} </multiline>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td height="20" align="center" valign="top">&nbsp;</td>
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <tbody>
                                                ...
                                                <td align="left" valign="top">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                        <td align="left" valign="top"
                                                            style="font-family: 'Gotham', sans-serif; font-size:15px; color:#3f3d3d; font-weight:400; line-height:24px;"
                                                            mc:edit="1-row-2-title">
                                                            <multiline>Vat </multiline>
                                                        </td>
                                                        </tr>
                                                    </tbody>
                                                    </table>
                                            ...
                                            <tbody>
                                                ...
                                                <td align="right" valign="top"
                                                    style="font-family: 'Gotham', sans-serif; font-size:15px; color:#000000; font-weight:600; line-height:24px;"
                                                    mc:edit="1-row-2-title">
                                                    <multiline>AED {{ $order['getPayment']['vat'] }} </multiline>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td height="20" align="center" valign="top">&nbsp;</td>
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <tbody>
                                                ...
                                                <td align="right" valign="top"
                                                    style="font-family: 'Gotham', sans-serif; font-size:15px; color:#000000; font-weight:600; line-height:24px;"
                                                    mc:edit="1-row-2-title">
                                                    <multiline>AED {{ $order['getPayment']['shipping'] }} </multiline>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td height="20" align="center" valign="top">&nbsp;</td>
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <tbody>
                                                ...
                                                <td align="right" valign="top"
                                                    style="font-family: 'Gotham', sans-serif; font-size:15px; color:#000000; font-weight:600; line-height:24px;"
                                                    mc:edit="1-row-2-title">
                                                    <multiline>AED {{ $order['getPayment']['delivery_charge'] }} </multiline>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td height="20" align="center" valign="top">&nbsp;</td>
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <tbody>
                                                ...
                                                <td align="right" valign="top"
                                                    style="font-family: 'Gotham', sans-serif; font-size:15px; color:#000000; font-weight:600; line-height:24px;"
                                                    mc:edit="1-row-2-title">
                                                    <multiline>AED {{ $order['getPayment']['total'] }} </multiline>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td height="20" align="center" valign="top">&nbsp;</td>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tbody>
                        ...
                        <td align="center" valign="top">
                            ...
                            <tbody>
                                <tr>
                                <td height="245" align="center" valign="middle" bgcolor="#0f0c0b"
                                    style="background: url('images/email-template-images/view-order.jpg') #0f0c0b no-repeat; height:245px;">
                                    ...
                                    <tbody>
                                        ...
                                        <td align="center" valign="top">
                                            ...
                                            <tbody>
                                                <tr>
                                                <td align="center" valign="top"
                                                    style="font-family: 'Gotham', sans-serif; font-size:30px; color:#FFF; font-weight:normal;"
                                                    mc:edit="have-qustion-title">
                                                    <multiline>To see your order detail </multiline>
                                                </td>
                                                </tr>
                                                ...
                                                <td align="center" valign="top">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                        <td height="42" align="center" valign="middle" bgcolor="#000000"
                                                            style="background:#000000; font-family: 'Gotham', sans-serif; font-size:16px; color:#FFF; font-weight:normal; line-height:24px; -moz-border-radius: 4px;border-radius: 4px;"
                                                            mc:edit="have-qustion-button">
                                                            <multiline><a href="{{ env('APP_URL').'get-order-details/ae-en/'.$order['session_id'] }}" target="_blank" style="color:#FFF; text-decoration:none;"> View Order </a></multiline>
                                                        </td>
                                                        </tr>
                                                    </tbody>
                                                    </table>
                                            ...
                                            <tr>
                                                ...
                                                <table width="180" border="0" align="right" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <td align="left" valign="top">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td align="left" valign="top" style="font-family: 'Gotham', sans-serif; font-size:16px; color:#3f3d3d; font-weight:500;" mc:edit="service-icon2-title">
