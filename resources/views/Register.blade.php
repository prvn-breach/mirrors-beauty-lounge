                          ...
                          <table border="0" align="right" cellpadding="0" cellspacing="0" class="two-left">
                            <tr>
                              <td align="center" valign="top"
                                ...
                                mc:edit="date">
                                <multiline>{{ date('Y/m/d') }}, {{ date('H:i A') }}</multiline>
                              </td>
                            </tr>
                            <tr>
                              <td align="center" valign="top">&nbsp;</td>
                          ...
                          <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                            <tr>
                              <td align="center" valign="top"
                                ...
                                <multiline>Welcome to mirrors beauty lounge </multiline>
                              </td>
                            </tr>
                          </table>
                        </td>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td align="right" valign="top"
                                        style="font-family: 'Gotham', sans-serif; font-size:15px; color:#000000; font-weight:600; line-height:24px;"
                                        mc:edit="1-row-2-title">
                                        <multiline>{{ $user['email'] }} </multiline>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td height="20" align="center" valign="top">&nbsp;</td>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td align="right" valign="top"
                                        style="font-family: 'Gotham', sans-serif; font-size:15px; color:#000000; font-weight:600; line-height:24px;"
                                        mc:edit="1-row-2-title">
                                        <multiline>{{ $user['mobile'] }} </multiline>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td height="20" align="center" valign="top">&nbsp;</td>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td align="right" valign="top"
                                        style="font-family: 'Gotham', sans-serif; font-size:15px; color:#000000; font-weight:600; line-height:24px;"
                                        mc:edit="1-row-2-title">
                                        <multiline>{{ $user['password'] }} </multiline>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td height="20" align="center" valign="top">&nbsp;</td>
                  ...
                  <tbody>
                    <tr>
                      <td height="245" align="center" valign="middle" bgcolor="#0f0c0b"
                        style="background: url('images/pwd.jpg') #0f0c0b no-repeat; height:245px;">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td align="center" valign="top"
                                        ...
                                        <multiline>Complete your profile </multiline>
                                      </td>
                                    </tr>
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              <td height="42" align="center" valign="middle" bgcolor="#000000"
                                                ...
                                                <multiline><a href="{{ env('APP_URL').'get-profile/ae-en' }}" style="color:#FFF; text-decoration:none;"> View Profile </a></multiline>
                                              </td>
                                            </tr>
                                          </tbody>
                                        </table>
