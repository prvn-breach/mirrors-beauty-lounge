...
<head>
    ...
    <title>Order Place Succesfully </title>
    <style type="text/css">
        body {
            width: 100%;
                                ...
                                <tr>
                                    ...
                                    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                        ...
                                        <td align="center" valign="top"
                                            ...
                                            mc:edit="single-post-image-title">
                                            <multiline>Your order has been place succesfully </multiline>
                                        </td>
                                        </tr>
                                        <tr>
                                        <td align="center" valign="top"
                                            ...
                                            <tr>
                                                ...
                                                <table width="185" border="0" align="left" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top"><img border="1" mc:edit="1-row-1-image" editable="true"
                                                        src="{{ $message->embed(public_path('images/products/'.$item['product_image']['image'])) }}" width="185" height="185"
                                                        style="display:block; border-color: #ebebeb;" alt="" /></td>
                                                        @endif
                                                    </tr>
                                                    <tr>
                                                ...
                                                <table width="330" border="0" align="right" cellpadding="0" cellspacing="0" class="two-left">
                                                    ...
                                                    <td align="left" valign="top">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <multiline>{{ !empty($item['brand']) ? $item['brand']['name'] : '' }} </multiline>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" valign="top"
                                                            ...
                                                            <td align="left" valign="top">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <td align="right" valign="top"
                                                                        ...
                                                                        mc:edit="1-row-2-title">
                                                                        <multiline>{{ $payment_data['payment_mode'] }} </multiline>
                                                                    </td>
                                                                    </tr>
                                                                    <tr>
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <tbody>
                                                ...
                                                <td align="right" valign="top"
                                                    style="font-family: 'Gotham', sans-serif; font-size:15px; color:#000000; font-weight:600; line-height:24px;"
                                                    mc:edit="1-row-2-title">
                                                    <multiline>AED {{ $payment_data['sub_total'] }} </multiline>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td height="20" align="center" valign="top">&nbsp;</td>
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <tbody>
                                                ...
                                                <td align="right" valign="top"
                                                    style="font-family: 'Gotham', sans-serif; font-size:15px; color:#000000; font-weight:600; line-height:24px;"
                                                    mc:edit="1-row-2-title">
                                                    <multiline>AED {{ $payment_data['vat'] }} </multiline>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td height="20" align="center" valign="top">&nbsp;</td>
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <tbody>
                                                ...
                                                <td align="right" valign="top"
                                                    style="font-family: 'Gotham', sans-serif; font-size:15px; color:#000000; font-weight:600; line-height:24px;"
                                                    mc:edit="1-row-2-title">
                                                    <multiline>AED {{ $payment_data['shipping'] }} </multiline>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td height="20" align="center" valign="top">&nbsp;</td>
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <tbody>
                                                ...
                                                <td align="right" valign="top"
                                                    style="font-family: 'Gotham', sans-serif; font-size:15px; color:#000000; font-weight:600; line-height:24px;"
                                                    mc:edit="1-row-2-title">
                                                    <multiline>AED {{ $payment_data['delivery_charge'] }} </multiline>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td height="20" align="center" valign="top">&nbsp;</td>
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <tbody>
                                                ...
                                                <td align="right" valign="top"
                                                    style="font-family: 'Gotham', sans-serif; font-size:15px; color:#000000; font-weight:600; line-height:24px;"
                                                    mc:edit="1-row-2-title">
                                                    <multiline>AED {{ $payment_data['total'] }} </multiline>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td height="20" align="center" valign="top">&nbsp;</td>
                                                ...
                                                <td align="center" valign="top">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td height="42" align="center" valign="middle" bgcolor="#000000"
                                                            ...
                                                            <multiline><a href="{{ $url }}" target="_blank" style="color:#FFF; text-decoration:none;"> View Order </a></multiline>
                                                        </td>
                                                        </tr>
                                                    </tbody>
                                                    </table>
